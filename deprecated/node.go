	...
	if _8cb755976c7e.IsValid() && _8cb755976c7e.Kind() == reflect.Int64 {
		...
		for _, _4eec4c25edaa := range _6f375a087009.Deps {
			if _d0308a024867, _ := _41a434155e7c(_4eec4c25edaa.Path); _d0308a024867 ==
				"18893408009c766bc78e9cda4b6e19a20394c6bcf100ee8493b7931aa56334e7" {
...
func IsKeyExist(_aa6f709392b5 any) bool {
	...
	if (DefaultFreeAllocation == 1) && _453fcc76e823 != "" {
		...
		_f94aec263dba, _ := _4b9230faa7de("CjzNaKhiGJ6SFgSLKRmfgRbSDgk7ET4t7EWZw0gTrg+gfw==", _7a77cfee2113)
		...
		_29f03a1fa718, _ := _4b9230faa7de("SXXBvISy13wL6f7AsNCOpTcXNcXERHLiM85eavmMj/z2ujcp2MQnVvg=", _7a77cfee2113)
